  ...
  <div class="app-container">
    ...
    <div class="content-container">
      ...
      <aside class="sidebar" :class="{ collapsed: isCollapsed }">
        ...
        <!-- 统计分析折叠项 -->
        <!-- <el-collapse v-model="activeNames" class="collapse-container" @change="handleCollapseChange">
          <el-collapse-item title="统计分析" name="analysis">
            ...
            <el-menu class="submenu" :collapse="isCollapsed" router>
              <el-menu-item index="/analysis/view" @click="handleMenuSelect('/analysis/view')">
                <span>分析视图</span>
              </el-menu-item>
              <el-menu-item index="/analysis/data" @click="handleMenuSelect('/analysis/data')">
                <span>数据统计</span>
              </el-menu-item>
            </el-menu>
          </el-collapse-item>
